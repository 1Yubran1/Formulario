...
app.post('/submit/form1', (req, res) => {
    ...
    saveDataToFile(data, 'form1.json');
...
app.post('/submit/form2', (req, res) => {
    ...
    saveDataToFile(data, 'form2.json');
...
app.post('/submit/form3', (req, res) => {
    ...
    saveDataToFile(data, 'form3.json');
...
app.post('/submit/form4', (req, res) => {
    ...
    saveDataToFile(data, 'form4.json');
...
app.post('/submit/form5', (req, res) => {
    ...
    saveDataToFile(data, 'form5.json');
...
app.post('/submit/form6', (req, res) => {
    ...
    saveDataToFile(data, 'form6.json');
...
app.post('/submit/form7', (req, res) => {
    ...
    saveDataToFile(data, 'form7.json');
...
app.post('/submit/form8', (req, res) => {
    ...
    saveDataToFile(data, 'form8.json');
...
app.post('/submit/form9', (req, res) => {
    ...
    saveDataToFile(data, 'form9.json');
...
app.post('/submit/form10', (req, res) => {
    ...
    saveDataToFile(data, 'form10.json');
...
app.post('/submit/form11', (req, res) => {
    ...
    saveDataToFile(data, 'form11.json');
...
app.post('/submit/form12', (req, res) => {
    ...
    saveDataToFile(data, 'form12.json');
...
app.post('/submit/form13', (req, res) => {
    ...
    saveDataToFile(data, 'form13.json');
...
app.post('/submit/form14', (req, res) => {
    ...
    saveDataToFile(data, 'form14.json');
...
app.post('/submit/form15', (req, res) => {
    ...
    saveDataToFile(data, 'form15.json');
...
app.post('/submit/form16', (req, res) => {
    ...
    saveDataToFile(data, 'form16.json');
...
app.post('/submit/form17', (req, res) => {
    ...
    saveDataToFile(data, 'form17.json');
...
app.post('/submit/form18', (req, res) => {
    ...
    saveDataToFile(data, 'form18.json');
...
app.post('/submit/form19', (req, res) => {
    ...
    saveDataToFile(data, 'form19.json');
...
app.post('/submit/form20', (req, res) => {
    ...
    saveDataToFile(data, 'form20.json');
...
app.post('/submit/form21', (req, res) => {
    ...
    saveDataToFile(data, 'form21.json');
...
app.post('/submit/form22', (req, res) => {
    ...
    saveDataToFile(data, 'form22.json');
...
app.post('/submit/form23', (req, res) => {
    ...
    saveDataToFile(data, 'form23.json');
...
app.post('/submit/form24', (req, res) => {
    ...
    saveDataToFile(data, 'form24.json');
...
app.post('/submit/form25', (req, res) => {
    ...
    saveDataToFile(data, 'form25.json');
...
app.post('/submit/form26', (req, res) => {
    ...
    saveDataToFile(data, 'form26.json');
...
app.post('/submit/form27', (req, res) => {
    ...
    saveDataToFile(data, 'form27.json');
...
app.post('/submit/form28', (req, res) => {
    ...
    saveDataToFile(data, 'form28.json');
...
app.post('/submit/form29', (req, res) => {
    ...
    saveDataToFile(data, 'form29.json');
...
app.post('/submit/form30', (req, res) => {
    ...
    saveDataToFile(data, 'form30.json');
